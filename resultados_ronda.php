        ...
        <section id="intro_login">
            <div id="cajon_torneo">
                ...
                <p> 
                    ...
                    <i>Una vez terminado todo el procedimiento el torneo será guardado en el perfil.</i>
                    <br>
                </p>
                <br>
                <div id="box_torneo">
                <div id="cajon_ronda">
                    ...
                    ?>
                        <div class="enfrentamiento-caja">
                            <h2 class="ronda">Ronda 1</h2>
                            <div class="contenido">
                                <div class="jugador jugador-1">
                                    <div class="nombre"><?php echo $enfrentamientoMostrar['nombre_alumno1']; ?></div>
                                    <div class="puntos">Puntos: <?php echo $alumno1Puntos; ?></div>
                                </div>
                                <div class="jugador jugador-2">
                                    <div class="nombre"><?php echo $enfrentamientoMostrar['nombre_alumno2']; ?></div>
                                    <div class="puntos">Puntos: <?php echo $alumno2Puntos; ?></div>
                                </div>
                            </div>
                        </div>
                        <br>
                        <div class="ganador"><?php echo "Ganador: " . ($alumnoGanadorId == $enfrentamientoMostrar['alumno1_id'] ? $enfrentamientoMostrar['nombre_alumno1'] : $enfrentamientoMostrar['nombre_alumno2']); ?></div>
                    <?php
                    }
                ...
                <a id="add_alumnos" href="php/crear_ronda_adicional.php?ronda_id=<?php echo $rondaAdicionalId; ?>">Siguiente ronda</a>
            </div>
        </section>
    </div>
